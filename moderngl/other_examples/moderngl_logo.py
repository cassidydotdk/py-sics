# ModernGL Logo - Original file found here: https://github.com/moderngl/moderngl-window/blob/master/examples/moderngl_logo.py
# Example of having embedded shaders straight in the .py file, as well as using NumPy for fast number/array processing
